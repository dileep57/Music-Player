...
//     helper.closedatabase()
        ...
        fun setcolortheme(num: Int) {
            when (num) {
                0 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.Blue).apply()
                1 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.BlueViolet).apply()
                2 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.Brown).apply()
                3 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.CadetBlue).apply()
                4 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.Chocolate).apply()
                5 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.CornflowerBlue).apply()
                6 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.Crimson).apply()
                7 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.DarkBlue).apply()
                8 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.DarkCyan).apply()
                9 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.DarkGray).apply()
                10 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.DarkGrey).apply()
                11 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.DarkGreen).apply()
                12 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.DarkMagenta).apply()
                13 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.DarkOrange).apply()
                14 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.DarkOrchid).apply()
                15 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.DarkRed).apply()
                16 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.DarkSlateBlue).apply()
                17 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.DarkSlateGray).apply()
                18 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.DarkSlateGrey).apply()
                19 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.DarkViolet).apply()
                20 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.DeepPink).apply()
                21 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.DimGray).apply()
                22 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.DodgerBlue).apply()
                23 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.FireBrick).apply()
                24 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.ForestGreen).apply()
                25 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.Fuchsia).apply()
                26 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.GoldenRod).apply()
                27 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.Gray).apply()
                28 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.Green).apply()
                29 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.GreenYellow).apply()
                30 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.HotPink).apply()
                31 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.IndianRed).apply()
                32 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.Indigo).apply()
                33 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.LightGrey).apply()
                34 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.LightGreen).apply()
                35 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.LightPink).apply()
                36 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.LightSalmon).apply()
                37 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.LightSeaGreen).apply()
                38 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.LightSkyBlue).apply()
                39 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.LightSlateGray).apply()
                40 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.LightSlateGrey).apply()
                41 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.Lime).apply()
                42 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.LimeGreen).apply()
                43 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.Magenta).apply()
                44 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.Maroon).apply()
                45 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.MediumBlue).apply()
                46 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.MediumOrchid).apply()
                47 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.MediumPurple).apply()
                48 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.MediumSeaGreen).apply()
                49 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.MediumSlateBlue).apply()
                50 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.MediumSpringGreen).apply()
                51 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.MediumVioletRed).apply()
                52 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.MidnightBlue).apply()
                53 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.Navy).apply()
                54 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.Orange).apply()
                55 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.OrangeRed).apply()
                56 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.Orchid).apply()
                57 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.PaleVioletRed).apply()
                58 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.Pink).apply()
                59 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.Plum).apply()
                60 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.Purple).apply()
                61 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.RebeccaPurple).apply()
                62 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.Red).apply()
                63 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.RoyalBlue).apply()
                64 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.SeaGreen).apply()
                65 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.Silver).apply()
                66 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.SlateBlue).apply()
                67 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.SlateGray).apply()
                68 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.SpringGreen).apply()
                69 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.SteelBlue).apply()
                70 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.Teal).apply()
                71 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.Tomato).apply()
                72 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.Violet).apply()
                73 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.Yellow).apply()
                74 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.YellowGreen).apply()
                75 -> Wel.colorshared.edit().putInt(Constants.THEMENAME, R.style.AppFullScreenTheme).apply()
            }
        }
...
//        }
        ...
        fun servicearray(section: String, album_name: String? = null, artist_name: String? = null, playlist_name: String? = null, firstopen: Boolean = false, cntx: Context? = null) {
            ...
            if (section.equals(Home.shared.getString(Constants.CURRENT_ALBUM, "alb"), ignoreCase = true) && !firstopen) {
                if (section.equals(Constants.SONG_FROM_ARTIST, ignoreCase = true)) {
                    if (Home.shared.getString(Constants.ARTIST_NAME, "alb").equals(artist_name, ignoreCase = true)) {
                        return
                    }
                } else if (section.equals(Constants.SONG_FROM_ALBUM, ignoreCase = true)) {
                    ...
                    if (Home.shared.getString(Constants.SONG_FROM_PLAYLIST, "alb").equals(playlist_name, ignoreCase = true)) {
                        return
                    }
                } else {
                    return
        ...
        fun playandpause(context: Context?) {
            val isServiceRunning = isServiceRunning(SongService::class.java.getName(), context!!)
            if (!isServiceRunning) {
